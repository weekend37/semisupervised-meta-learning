...
class SSMLMAMLGAN(MAMLGAN):
    ...
    def train(self, iterations=5):
        ...
        iteration_count = self.load_model() # D: this should be zero whenever we start from scratch, i.e. not from checkpoint
        ...
        epoch_count = iteration_count // N # D: this should be zero whenever we start from scratch, i.e. not from checkpoint
            ...
            for d, dataset in enumerate([maml_gan_train_dataset, maml_train_dataset]):
                ...
                while should_continue_inner:
                    for (train_ds, val_ds), (train_labels, val_labels) in dataset:
                        ...
                        if d == 1 and iteration_count_inner == 0:
                            print(val_ds[0][0][0][0][0][0])
