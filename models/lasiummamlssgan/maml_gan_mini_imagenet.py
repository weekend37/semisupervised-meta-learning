...
from models.lasiummamlssgan.database_parsers import OmniglotParser, MiniImagenetParser
...
if __name__ == '__main__':
    ...
    gan.perform_training(epochs=100, checkpoint_freq=10)
    ...
    maml_gan.train(iterations=20000)
    maml_gan.evaluate(10, 20, seed=42)
